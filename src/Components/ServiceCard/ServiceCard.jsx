...
<div>
        ...
        <div class=" p-6 text-center bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            ...
            <p class="mb-3 font-normal text-gray-500 dark:text-gray-400">{service_description.slice(0,150)}</p>
            <p className="font-bold ">Price: {price}</p>
            <a href="#" class="inline-flex items-center text-orange-500 hover:underline">
                See service details
