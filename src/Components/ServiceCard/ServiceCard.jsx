...
<div>
        ...
        <div className=" cardShadow  p-6 text-center bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            ...
            <p className="mb-3 font-normal  text-black dark:text-gray-400">{service_description.slice(0,150)}</p>
            <p className="font-bold ">Price: {price}</p>
            <Link to={`/details/${id}`} className="inline-flex items-center text-orange-500 hover:underline">
                See service details
                <svg className=" h-3 ml-2.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 18">
